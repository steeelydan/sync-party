            ...
            if (
                ...
                if (
                    ...
                    redirectionToHttpsApp.listen(80, () => {
                        logger.log(
                            'info',
                            'HTTPS Redirection server is listening'
                        );
                    });
                ...
                io.on('connection', (socket: any) => {
                    ...
                    socket.on('syncStatus', (userSyncStatus: any) => {
                        ...
                        currentSyncStatus[userSyncStatus.partyId][
                            ...
                            serverTimeOffset:
                                Date.now() - userSyncStatus.timestamp,
                    ...
                    socket.on('chatMessage', (chatMessage: any) => {
                        io.to(chatMessage.partyId).emit(
                            'chatMessage',
                            chatMessage
                        );
                    });
                ...
                peerServer.on('connection', async (client: any) => {
                    ...
                    for (const party of allParties) {
                        ...
                        if (partyWebRtcIds) {
                            for (const partyUserId of Object.keys(
                                partyWebRtcIds
                            )) {
                                const partyUserWebRtcId =
                                    partyWebRtcIds[partyUserId];
                ...
                app.get('/api/userItems', isAuthenticated, async (req, res) => {
                    await userItemController.getUserItems(
                        req,
                        res,
                        models,
                        logger
                ...
                app.post(
                    ...
                    isAdmin,
                    async (req, res) => {
                        await partyController.createParty(
                            req,
                            res,
                            models,
                            logger
                ...
                app.put(
                    ...
                    isAdmin,
                    async (req, res) => {
                        await partyController.editParty(
                            req,
                            res,
                            models,
                            logger
                ...
                app.get(
                    ...
                    isAuthenticated,
                    async (req, res) => {
                        await userPartyController.getUserParties(
                            req,
                            res,
                            models
                        );
                ...
                app.delete(
                    ...
                    isAuthenticated,
                    async (req, res) => {
                        await partyItemController.removeItemFromParty(
                            req,
                            res,
                            models
                        );
                ...
                app.post(
                    ...
                    isAuthenticated,
                    async (req, res) => {
                        await externalDataController.getLinkMetadata(
                            req,
                            res,
                            logger
                        );
